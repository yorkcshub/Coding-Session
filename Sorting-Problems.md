...
__Input:__ Input starts with a line containing three integers cx cy n where (cx,cy) is your location and 3 ≤ n ≤100 is the number of listening devices. The next n lines each contain three integers x y r, where (x,y) is the location of a listening device and 0 < r ≤ 1000 is the radius of its listening area. All coordinates are between −1000 and 1000. All n+1 locations are distinct.

__Output:__ Display the radius of the maximum broadcast area, rounding down to the nearest integer.
...
72
```
_This problem appeared in 2018 ICPC East-Central NA Regional Practice Contest._
